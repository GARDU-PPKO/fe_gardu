    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans selection:bg-green-200">
      ...
      {selectedDusun ? (
        ...
        <main>
          ...
          <ARSection />
          <TourPackages onBook={() => navigate('/booking/package')} />
          <UMKMSection />
          <KebudayaanSection />
          <StatistikSection />
          <KontakSection />
      ...
      <a
        href="https://wa.me/6281234567890?text=Halo%20Admin,%20saya%20ingin%20tanya%20tentang%20wisata%20Desa%20Getas"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#20ba5a] text-white p-3.5 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 active:translate-y-0 flex items-center justify-center group"

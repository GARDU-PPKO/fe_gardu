    ...
    <BookingLayout currentStep={3}>
      <div className="grid lg:grid-cols-[1fr_340px] gap-8">
        <div>
          ...
          <div className="bg-white border border-[#c5d0ff] rounded-2xl p-5 mb-8 shadow-sm">
            {!selectedFile ? (
              <div 
                className="border-2 border-dashed border-[#c5d0ff] hover:border-[#182cc1] rounded-xl p-8 text-center transition-colors cursor-pointer bg-[#fafcff] hover:bg-[#eef2ff]"
              ...
              <div className="border border-[#c5d0ff] rounded-xl p-4 bg-[#f8faff] flex items-center justify-between">
          ...
          <div className="bg-white rounded-2xl border border-[#c5d0ff] overflow-hidden mb-6 shadow-sm">
            <div className="p-5 border-b border-[#e8edff] flex items-center justify-between">
              <div>
